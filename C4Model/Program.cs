...
namespace C4Model
{
    class Program
    {
        ...
        static void Banking()
        {
            const long workspaceId = 55742;
            const string apiKey = "2838047f-b134-448d-b7e7-67b1e2ed02f0";
            const string apiSecret = "0a1a6df2-c34e-4157-b71c-eaf0869dcd86";
            ...
            restApi.Components.Where(c => "Net Core REST Controller".Equals(c.Technology)).ToList().ForEach(c => webApplication.Uses(c, "Uses", "HTTPS"));
